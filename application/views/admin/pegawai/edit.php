                        ...
                        <form class="row g-3" method="POST" action="<?= base_url()?>admin/pegawai/update">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-8"> 
                                    ...
                                    <input type="text" 
                                            class="form-control <?php echo form_error('inputNik') ? 'is-invalid':'' ?>" 
                                            name="inputNik" 
                                            id="inputNik"
                            ...
                            <div class="row g-2">
                                <div class="col-md-3"> 
                                    ...
                                    <select name="inputGelarDepan" name="inputGelarDepan" class="form-select" style="width: 100%">
                                        ...
                                        <option value="Prof."
                                                <?php echo ($pegawai->gelar_depan == 'Prof.' ? 'selected' : '' ); ?>>Prof.</option> 
                                    </select>
                                </div>
                                <div class="col-md-6"> 
                                ...
                                <div class="col-md-3"> 
                                    ...
                                    <select name="inputGelarBelakang" name="inputGelarBelakang" class="form-select" style="width: 100%">
                                        ...
                                        <option value="M.Ag"
                                                <?php echo ($pegawai->gelar_belakang == 'M.Ag' ? 'selected' : '' ); ?>>M.Ag</option> 
                                    </select>
                                </div>
                            </div>
                            <div class="row g-2">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <input type="text" 
                                            class="form-control" 
                                            name="inputTmtPegawai"
                                            value="<?php echo $pegawai->tmt_pegawai; ?>">
                                </div>
                            </div>
                            <div class="row g-2">
                                <div class="col-md-4"> 

                                    ...
                                    <div class="row g-2 mt-2">
                                        <div class="col-md-4">
                                            ...
                                            <select name="inputJenisKelamin" class="form-select" style="width: 100%">
                                                <option disabledvalue="<?= $tendik['jenis_kelamin']; ?>"><?= $tendik['jenis_kelamin']; ?></option>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="inputStatusKeaktifan form-select" name="inputKeaktifan" style="width: 100%">
                                                <option disabled value="<?= $tendik['status_keaktifan']; ?>"><?= $tendik['status_keaktifan']; ?></option>
                                    ...
                                    <div class="row ">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" name="inputNoSKCalonPegawai" id="inputNoSKCalonPegawai" value="<?= $tendik['no_sk_calon_pegawai']; ?>">
                                        </div>
                                        <div class="col">
                                            <label for="inputTMTSKCalonPegawai" class="form-label">TMT SK Calon Pegawai</label>
                                            <input type="date" class="form-control" name="inputTMTSKCalonPegawai" id="inputTMTSKCalonPegawai" value="<?= $tendik['tmt_calon_pegawai']; ?>">
                                        </div>
                                        <div class="col">
                                            <label for="inputNoSKPegawaiTetap" class="form-label">Nomor SK Pegawai Tetap</label>
                                            <input type="text" class="form-control" name="inputNoSKPegawaiTetap" id="inputNoSKPegawaiTetap" value="<?= $tendik['no_sk_pegawai_tetap']; ?>">
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col">
                                    ...
                                    <div class="row ">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" name="inputJabatanFungsional" id="inputJabatanFungsional" value="<?= $tendik['jabfung']; ?>">
                                        </div>
                                    </div>
                                    <div class="row ">
                                        <div class="col">

    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url() ?>admin/tendik">Data Tenaga Kependidikan</a></li>
                <li class="breadcrumb-item active">Edit Data Tenaga Kependidikan</li>
            </ol>
        </nav>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Data Tenaga Kependidikan</h5>

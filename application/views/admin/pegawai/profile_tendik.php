                ...
                <div class="row g-0">
                    <div class="col-md-4">
                        <div class="profile-card pt-4 d-flex flex-column align-items-center ">
                            ...
                            <h3 class=""> <?= $tendik['nama_jabatan'] . " " . $tendik['nama_unit']; ?>
                            </h3>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-8"><?= $tendik['tempat_lahir']; ?>, <?= date('d F Y', strtotime($tendik['tanggal_lahir'])); ?></div>
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row ms-4">
                            ...
                            <div class="col-lg-7 col-md-8"><?= $tendik['nik']; ?></div>
                        </div>
                        <div class="row ms-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row ms-4">
                                ...
                                <div class="col-lg-7 col-md-8"><?= $tendik['alamat'] ?></div>
                            </div>

                            <div class="row ms-4">
                                <div class="col-lg-5 col-md-4 label fw-bold">Phone</div>
                                <div class="col-lg-7 col-md-8"><?= $tendik['kontak'] ?></div>
                            </div>

                            <div class="row ms-4">
                                <div class="col-lg-5 col-md-4 label fw-bold">Email</div>
                                <div class="col-lg-7 col-md-8"><?= $tendik['email_pribadi'] ?></div>
                                <div class="d-md-flex justify-content-md-end mt-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row ms-4">
                                ...
                                <div class="col-lg-7 col-md-8"><?= $tendik['nama_wajib_pajak']; ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row ms-4">
                            ...
                            <div class="col-lg-7 col-md-8"><?= $tendik['status_pernikahan'] ?></div>
                        </div>
                        <div class="row ms-4">
                        ...
                        <div class="row ms-4">
                            ...
                            <div class="col-lg-7 col-md-8"><?= $tendik['jumlah_tanggungan'] ?></div>
                            <div class="d-md-flex justify-content-md-end mt-3 ">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row ms-4">
                                ...
                                <div class="col-lg-7 col-md-8"><?= $tendik['nama_unit']; ?></div>
                            </div>
                            <div class="row ms-4">
                ...
                <div class="modal-body">
                    <form method="post" action="<?php echo base_url(); ?>dosen/saveprofile">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input name="nidn" type="text" class="form-control" id="nidn" value="<?= $tendik['id_pegawai']; ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Nama Depan</label>
                            <div class="col-md-8 col-lg-9">
                                <input name="namadpn" type="text" class="form-control" id="namadpn" value="<?= $tendik['nama_depan']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input name="namatgh" type="text" class="form-control" id="namatgh" value="<?= $tendik['nama_tengah']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <input name="namablkg" type="text" class="form-control" id="namablkg" value="<?= $tendik['nama_belakang']; ?>">
                            </div>
                        </div>
                        <div class="row mb-3">

                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?= $dosen['nama'] ?></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?= $dosen['tempat-lahir']; ?>, <?= date('d F Y', strtotime($dosen['tanggal_lahir'])); ?></div>
                                    </div>
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <!-- Profile Edit Form -->
                                    <?= form_open('admin/fungsi/aksiEditProfileDosen') ?>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <input type="hidden" name="no_pegawai" id="no_pegawai" value="<?= $dosen['no_pegawai'];?>">
                                    <div class="row mb-3">
                                        <label for="nidn" class="col-md-4 col-lg-3 col-form-label">NIDN</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input name="id_pegawai" type="text" class="form-control" id="id_pegawai" value="<?= $dosen['id_pegawai']; ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="nik" type="text" class="form-control" id="nik" value="<?= $dosen['nik']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="tempat_lahir" type="text" class="form-control" id="tempat_lahir" value="<?= $dosen['tempat-lahir']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="ttl" class="col-md-4 col-lg-3 col-form-label">TTL</label>
                                        <div class="col-md-8 col-lg-9">
                                            <input name="tanggal_lahir" type="date" class="form-control" id="tanggal_lahir" value="<?= $dosen['tanggal_lahir']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <select name="agama" type="text" class="form-select" id="agama">
                                                <option selected value="<?= $dosen['agama'];?>"><?= $dosen['agama'];?></option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <select name="prodi" type="text" class="form-select" id="prodi">
                                                <option selected value="<?= $profak['id_prodi'];?>"><?= $profak['nama_prodi'];?></option>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="alamat" type="text" class="form-control" id="alamat" value="<?= $dosen['alamat']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="phone" type="text" class="form-control" id="Phone" value="<?= $dosen['kontak']; ?>">
                                        </div>
                                    </div>
